...
void I2C_Initialization(void){
	...
	// PRESC = 9
	// f_presc = 8 * 10^6
	// t_presc = 125 * 10^-9 or .125µs
	// SCLDEL = 7
	// SDADEL = 9
	// SCLH = 31
	// SCLL = 37
	
	I2C1->TIMINGR |= ((9UL << I2C_TIMINGR_PRESC_POS) | (7UL << I2C_TIMINGR_SCLDEL_POS) | (9UL << I2C_TIMINGR_SDADEL_POS) | (31UL << I2C_TIMINGR_SCLH_POS) | (37UL << I2C_TIMINGR_SCLL_POS));
	I2C1->OAR2 &= ~I2C_OAR1_OA1EN;
	I2C1->OAR1 &= ~I2C_OAR2_OA2EN;
	I2C1->OAR1 &= ~I2C_OAR1_OA1MODE;
	I2C1->OAR1 |= OwnAddr << 1UL;
